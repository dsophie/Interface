...
<html lang="en">
    <head>
       <!-- Page 2 of 3 of registration process -->
        <meta charset="utf-8">
        ...
        <script type="text/javascript" src="regform/validation2.js"></script>      
    ...
    <body>
        ...
        <div class="block" id="main">
            ...
            <form onsubmit="return validate();" method="post" action="regform/handleform2.php">

                <fieldset> #2 Let's get to know each other </fieldset>
                ...
                <!-- List of all countries found on internet -->
                <select name="country">
                    <option value=""> </option>
